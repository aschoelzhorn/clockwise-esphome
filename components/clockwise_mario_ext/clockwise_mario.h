...
class MarioClock : public esphome::PollingComponent {
 public:
  MarioClock() : PollingComponent(16) {}
...
protected:
  ...
  //class Clockface;                 // from cw-cf-0x-01
  Clockface* clockface_{nullptr};  // the real Mario face
};
